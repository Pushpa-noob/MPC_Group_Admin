...
@Component({
  selector: 'app-loggedin-clients',
  templateUrl: './loggedin-clients.component.html',
  styleUrls: ['./loggedin-clients.component.scss']
})
export class LoggedinClientsComponent {
  details: any = [];
  websiteMode: any = [];
  getRoleId:number =0;
  type:string = "Login";
